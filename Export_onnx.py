...
torch.onnx.export(model, dummy_input, "deeplab_nearest.onnx", verbose=True, input_names=input_names, output_names=output_names,operator_export_type=OperatorExportTypes.ONNX_ATEN_FALLBACK)
